...
$THETA  (0,0.244225) FIX; 1 prop Error
 (0,0.0630253) FIX; 2 add Error
 (0,7.12) FIX ; 3 CL L/h
 (0,89.4) FIX ; 4 V L
 (0,0.283) FIX ; 5 KA 1/h
 (0,0.207055) FIX; 6 metab prop Error
 (0,0.0586032) FIX; 7 metab add Error
 (0,13.5) FIX ; 8 Q
 (0,182) FIX ; 9 V2
 (0,12.8) FIX ; 10 CLM
 (0,38.9) FIX ; 11 VM
 (0,41.3) FIX ; 12 QM
 (0,353) FIX ; 13 VM2
 (0,0.00601401) FIX; 14 KPL7
 (0,11.2866) FIX; 15 PC7
 0 FIX ; 16 DISTCOV
 (0,0.0116569) FIX; 17 KPL8
 (0,12.9673) FIX; 18 PC8
 0 FIX ; 19 DISTCOV
 (0,1.64061) FIX; 20 DISTCOVGAMMA
 (0,1.86831) FIX; 21 DISTCOVMETABGAMMA
