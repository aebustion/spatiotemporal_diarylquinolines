...
$DATA      TBAJ876_restructured_ids_distance.csv IGNORE=@
            IGNORE(CMPD.EQ.1) IGNORE(BLQ.EQ.1)
...
$THETA  (0,0.005) FIX ; 1 Prop error
 ...
 (0,2.17525) FIX; 14 DISTCOVGAMMAM
 (0,0.348918,10) FIX; 15 KPL7
 (0,14.0508) FIX; 16 MAXPC7
 (0,0) FIX ; 17 prop error metabolite
 (0,0.710068) FIX; 17 additive error metabolite
$OMEGA  
 0.089401  FIX
 0.123201  FIX
$SIGMA  1  FIX
