...
$INPUT ID TIME DV EVID AMT CMT ADDL II DOSE DIST

$DATA      ./20240502_TBAJ587_DIST_longer.csv
IGNORE=@
IGNORE(DIST.GT.3000)
...
0 FIX ;0.176 FIX; F1
0 FIX ;0.138 FIX; MTT
0 FIX ;0.050 FIX; CLM3
0 FIX ;0.099 FIX; V2M3
...
$TABLE ID DOSE DIST TIME DV IPRED PRED CPP CPM A2 A5 A10 A11 AA10 AA11 EVID FILE=sdtabS587_04 NOPRINT ONEHEADER
