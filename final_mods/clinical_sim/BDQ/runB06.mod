;; 1. Based on: runX07b
;; 2. Description: BDQ QD dosing scenarios with variability
;; x1. Author: aebustion
;;
...
$INPUT ID DIST TIME TIMED AMT DV EVID RACE DOSE SEX DSTB FORM CMT II ADDL DOSE_TYPE MONTHS
$DATA ./20240502_BDQ_DIST_therapeutic_scenarios.csv IGNORE=C
IGNORE(TIME.GT.5376)
...
$TABLE ID REPID TIME EVID DV PRED IPRED CP CM CPP CPM A8 WTTIMEE AA9 AA10 DIST V VE VM2 VM2E MONTHS DOSE_TYPE
       RES IRES WRES IWRES CWRES NPDE NOPRINT ONEHEADER NOAPPEND FILE=sdtabB06
