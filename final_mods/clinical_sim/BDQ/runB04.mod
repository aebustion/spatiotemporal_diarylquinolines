;; 1. Based on: runX07b
;; 2. Description: BDQ by DIST, TV patients
;; x1. Author: aebustion
;;
...
$DATA ./BDQ_SIM_TO_SSh_DIST_varies_longer.csv IGNORE=C
...
$TABLE ID REPID TIME EVID DV PRED IPRED CP CM CPP CPM A8 WTTIMEE AA9 AA10 DIST V VE VM2 VM2E 
RES IRES WRES IWRES CWRES NPDE NOPRINT ONEHEADER NOAPPEND FILE=sdtabB04
